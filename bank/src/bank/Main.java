...
System.out.printf("Hi Mr. "+accountObject.getName()+"of your Account Number:"+accountObject.getAccountNumber()
 +"Maintenance Charge is Current Account %.2f",outputValue);
break;
case 2:
System.out.println("Name");
