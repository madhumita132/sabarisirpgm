		...
		try {
			...
			PreparedStatement statement =null;
			   ...
			   case "insert":
				   ...
				   String sql = "INSERT INTO product (pid,pname,pprice,pqty) VALUES (?, ?, ?, ?)";
			   ...
			   case "update":
				   ...
				   String p2=scan.next();
				   boolean up=st.execute("update product set pprice=30.3 where pname='"+p2+"'");
				   if(!up) {
			   ...
			   case "find": 
				   ...
				   String q1="select * from product where pname=?";
